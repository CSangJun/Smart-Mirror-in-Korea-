...
class Player(Tk.Frame):
    ...
    def __init__(self, parent, title=None):
        Tk.Frame.__init__(self, parent) # 프레임을 만든다. parent로 root를 지정.
    ...
    def OnOpen(self):
        ...
        if os.path.isfile(fullname):
            ...
            self.Media = self.Instance.media_new('https://r7---sn-3u-20nd.googlevideo.com/videoplayback?pl=23&fvip=4&ei=s48OW6zRBZb84gLC0q_4CA&ip=220.66.115.164&ratebypass=yes&pcm2cms=yes&requiressl=yes&key=yt6&mime=video%2Fmp4&source=youtube&id=o-AKOwWTD5AM0JSdh9psvL8DtCwgMJQiZys_gytK51BxEm&dur=202.895&mn=sn-3u-20nd%2Csn-ogul7n7z&mm=31%2C29&ipbits=0&c=WEB&expire=1527702547&lmt=1522990557891855&itag=22&ms=au%2Crdu&sparams=dur%2Cei%2Cid%2Cip%2Cipbits%2Citag%2Clmt%2Cmime%2Cmm%2Cmn%2Cms%2Cmv%2Cpcm2cms%2Cpl%2Cratebypass%2Crequiressl%2Csource%2Cexpire&mv=u&mt=1527680240&signature=2F26EEAD1466D7626E920013F569F60A7CCA128A.C2791FD21786CCB73F8DF72829E0BFF2F8115760')
...
def Tk_get_root():
    #attribute가 있는지 확인하고 있으면 있는 것을 그대로 사용, 없으면 root를 만들어서 저장.
...
if __name__ == "__main__":
    ...
    # root 함수를 호출해서 만든다. line 291
    root = Tk_get_root()
    #root에 WM_DELETE_WINDOW 메세지를 key값으로 _quit함수를 등록.
    root.protocol("WM_DELETE_WINDOW", _quit)

    #Player라는 클래스를 이용해서 작업. line 68
